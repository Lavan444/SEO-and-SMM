...
const navItems = [
    { label: "Website Analysis Setup", path: "/seo/search", icon: "feather-airplay" },
    { label: "Techanical Audit", path: "/seo/keywards-strategy", icon: "feather-search" },
    { label: "SEO Audit", path: "/settings/email", icon: "feather-tag" },
